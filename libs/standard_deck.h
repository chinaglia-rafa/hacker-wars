...
void stddk_load_standard_deck() {
	...
	STANDARD_DECK.cards[0] = crd_make_card("Enviar virus", 85.00, 20.00, 3.0, 500, 60.00);
	...
	STANDARD_DECK.cards[16] = crd_make_card("Caneca de cafe", 45.00, 40.00, 2.1, 300, 73.00);
	...
	STANDARD_DECK.cards[19] = crd_make_card("Cavalo de Troia", 58.00, 12.00, 2.6, 200, 33.00);
