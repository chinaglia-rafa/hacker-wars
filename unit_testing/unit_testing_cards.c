...
void main () {
	...
	printf("\nA %s do primeiro card na mao do jogador e %.0f.", hlp_label_at_pos(2, FORMAT_UPPER), crd_get_value_at(hand[0], 2));
	printf("\nA %s do primeiro card na mao do jogador e %.0f.", hlp_label_at_pos(3, FORMAT_CAP), crd_get_value_at(hand[0], 3));
	printf("\nO total de %s do primeiro card na mao do jogador e %.0f.", hlp_label_at_pos(4, FORMAT_LOWER), crd_get_value_at(hand[0], 4));
	printf("\nA %s do primeiro card na mao do jogador e %.0f.", hlp_label_at_pos(5, FORMAT_LOWER), crd_get_value_at(hand[0], 5));
